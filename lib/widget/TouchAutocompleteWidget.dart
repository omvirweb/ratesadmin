...
class TouchAutocompleteWidget extends StatelessWidget {
  final String name_txt;
  final AutofillDataController _autofillDataController = Get.find();
  final TextEditingController txtController;

  TouchAutocompleteWidget({Key? key, required this.name_txt, required this.txtController}) : super(key: key);
      ...
      child: Container(
        ...
        child: Autocomplete<String>(
          optionsBuilder: (TextEditingValue textEditingValue) {
            ...
            return _autofillDataController.touchListAuto
                .map((party) => party['touch'] as String)
